...
export default function ThankYouPage() {
  useEffect(() => {
    const redirect = setTimeout(() => {
      const phone = '917879026133' // Replace with your WhatsApp number
  ...
  return (
    <main className="p-6 flex flex-col items-center justify-center min-h-[70vh] text-center space-y-6">
      <div className="backdrop-blur-md bg-glass p-8 rounded-lg shadow-glass max-w-xl">
        ...
        <p className="text-sm text-white/60">(If it doesn’t happen, <a href="https://wa.me/917879026133" className="underline">click here</a>)</p>
      </div>
    </main>
  )
}
